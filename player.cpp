...
sprites_[SpriteState(STANDING, LEFT)] = boost::shared_ptr<Sprite>(new Sprite(graphics, "assets/MyChar.bmp", 0, 0, Game::kTileSize, Game::kTileSize));
sprites_[SpriteState(WALKING, LEFT)] = boost::shared_ptr<Sprite>(new AnimatedSprite(graphics, "assets/MyChar.bmp", 0, 0, Game::kTileSize, Game::kTileSize, 15, 3));

sprites_[SpriteState(STANDING, RIGHT)] = boost::shared_ptr<Sprite>(new Sprite(graphics, "assets/MyChar.bmp", 0, Game::kTileSize, Game::kTileSize, Game::kTileSize));
sprites_[SpriteState(WALKING, RIGHT)] = boost::shared_ptr<Sprite>(new AnimatedSprite(graphics, "assets/MyChar.bmp", 0, Game::kTileSize, Game::kTileSize, Game::kTileSize, 15, 3));
}
